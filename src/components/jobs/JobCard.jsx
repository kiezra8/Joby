        ...
        >
            <Link to={`/jobs/${job.id}`}>
                <div className="card-hover p-6 group cursor-pointer h-full flex flex-col">
                    ...
                    {/* Footer */}
                    <div className="flex items-center justify-between text-xs text-surface-400 dark:text-surface-500 pt-4 border-t border-surface-100 dark:border-surface-700/50">
